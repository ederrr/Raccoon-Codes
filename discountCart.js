...
//define which products should receive discount
function receiveDiscount(product) {
	return (product.product_price >= 500.00 && product.product_quantity == 1);
}

//output array with discounted products
var filtered_cart_products = cart_products.filter(receiveDiscount);

//print output on console
console.log(filtered_cart_products);
